...
namelb1 = Label(text = "Enter their name:")
namelb1.place(x = 50, y = 50, width = 100, height = 25)
...
genderlb1.place(x = 50, y = 100, width = 100, height = 25)
...
printlist = Button(text = "Print List", command = print_list)
printlist.place(x = 175, y = 300, width = 100, height = 25)
